 ...
 * Create admin pages
 */
add_action("admin_menu", "rm_create_admin_pages");
function rm_create_admin_pages() {
  global $submenu;
  add_menu_page(
    __('Request Metrics', 'request-metrics'),
    "Request Metrics",
    "manage_options",
    "rm_dashboard_page",
    "rm_render_dashboard_page",
